...
const edge = spawn(EDGE, ["--headless=new","--disable-gpu","--use-gl=swiftshader","--remote-debugging-port=9360","--user-data-dir="+OUT+"/edge-v2v","--window-size=1440,900","about:blank"], { stdio: "ignore" });
