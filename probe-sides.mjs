...
await send("Page.navigate",{url:"file:///C:/Users/fortn/ember-site/test-sides.html"});
await sleep(5000);
...
if (s.result?.data) writeFileSync(`${OUT}/ember-sides.png`, Buffer.from(s.result.data,"base64"));
